        ...
        <Grid inside={inside}>
            <User>
                <UserImg>
                    ...
                    {!commentParentNum ? (<ReplyButton onClick={() => commentId === replyId ? setReplyId(null) : setReplyId(commentId)} type="button"><FontAwesomeIcon icon={faReply} />&nbsp;답글</ReplyButton>) : null}
                </UserImg>
                <UserInfo>
                    <UserInfoCol>
