          ...
          <Wrapper>
            ...
            <Form onSubmit={handleSubmit(onVaild)}>
              <Input
                type="email"
                placeholder="email"
                {...register('email', { required: '⚠️ email를 입력해주세요.' })}
              />
              <span>{errors?.email?.message}</span>
              <Input
                type="password"
                placeholder="password"
                {...register('password', { required: '⚠️ password를 입력해주세요.' })}
              />
            ...
            <NaverOAuthLogin
              onClick={() => (window.location.href = 'https://sdmas-rabbit.fly.dev/api/auth/naver')}
            >
              <FontAwesomeIcon icon={faN} />
              &nbsp;네이버 로그인
            </NaverOAuthLogin>
            <KakaoOAuthLogin
              onClick={() => (window.location.href = 'https://sdmas-rabbit.fly.dev/api/auth/kakao')}
            >
